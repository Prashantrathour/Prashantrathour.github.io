  ...
  const projects = [
    {
      title: "Tradehub",
      description:
        "This web application allows users to sign up, log in, create a demat account, maintain a portfolio, buy and sell stocks. The platform is built with React, Redux, JSON Server, Chakra UI, CSS, HTML, and JavaScript In backend Nodejs express mongoDb for user Authentication we used jwt,bcrypt and firebase.",
      techStack:
        "React, Redux, Chakra UI, CSS,Tailwin css, HTML,JavaScript,Mondodb,express,nodejs,",
      duration: "5 Days",
    ...
    },
    {
      ...
      techStack:
        " React, Redux, JSON Server, Chakra UI, CSS, HTML, and JavaScript",
      duration: "5 Days",
      images: healthcare_images, // Replace with the actual image URL or import the image
      viewProjectLink:
        "https://github.com/Prashantrathour/ashamed-rainstorm-9299",
    ...
    },
    {
      title: "Myntra.com",
      description:
        "Cloning Myntra Website with my unique logo and name which is Infinity. Myntra is a Indian e-commerce which deal in fashion and clothing marketing and captured huge market.",
      techStack:
        "React, JavaScript, HTML, CSS, api , react-router , json-server chakra-ui",
      duration: "5 days",
    ...
    },
    {
      title: "Koovs.com",
      description:
        "Online shopping for women and men made easy at Koovs. Buy clothes and footwear online from latest collection of fashion apparel, accessories & more",
      ...
      liveDeployedLink:
        "https://storied-gumption-752ad0.netlify.app/index.html",
      Date: "March-2023",
    },
    {
      title: "Nykaa.com",
      description:
        "Nykaa, the online shopping beauty store. Browse makeup, health products & more from top beauty brands.",
      techStack: " JavaScript, HTML, CSS, api ,json-server",
      duration: "Oct 2022 - Present",
    ...
    <Box id="projects" position="relative" mt={20}>
      ...
      <Flex justifyContent="center" alignItems="center">
        <Box width="100%" color={["black", "black", "black", color]}>
          <VerticalTimeline
            animate={true}
            lineColor={colorMode === "light" ? "rgb(33, 150, 243)" : "white"}
          >
                ...
                <Box className="project-card">
                  ...
                  >
                    ...
                    <ProjectLinks>
                      <ViewProjectLink
                        onClick={() =>
                          openLinkInNewTab(project.viewProjectLink)
                        }
                        className="project-github-link"
                      >
                        <AiFillGithub style={{ marginRight: "5px" }} /> View
                        Project
                      </ViewProjectLink>
                      <LiveDeployedLink
                        onClick={() =>
                          openLinkInNewTab(project.liveDeployedLink)
                        }
                        className="project-deployed-link"
                      >
                        <RiExternalLinkLine style={{ marginRight: "5px" }} />{" "}
                        Live
                      </LiveDeployedLink>
                    </ProjectLinks>
                  </Box>
